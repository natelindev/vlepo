...
type RawSocialIconProps = { color: string };

const telegramSocialIcon = (props: RawSocialIconProps) => (
  <g fill="none" fillRule="evenodd">
    <SocialGroupOutline stroke="#000" strokeWidth="3" cx="50" cy="50" r="43.75" />
    <SocialGroupInnerCircle cx="50" cy="50" fill={props.color} r="42" />
    <SocialGroupIcon
...
const githubSocialIcon = (props: RawSocialIconProps) => (
  <g fill="none" fillRule="evenodd">
    <SocialGroupOutline stroke="#000" strokeWidth="20" cx="300" cy="300" r="262.5" />
    <SocialGroupInnerCircle fill={props.color} cx="300" cy="300" r="252.5" />
    <SocialGroupIcon
...
const SocialIcon = (props: SocialIconProps) => {
  ...
  const [size, color, SocialIconContent] = ((): [number, string, React.FC<{ color: string }>] => {
    switch (name) {
      case 'github':
        return [600, '#000', githubSocialIcon];
      case 'telegram':
        return [100, '#139BD0', telegramSocialIcon];
      default:
        return [0, '#000', (props: RawSocialIconProps) => null];
    }
  })();
